...
@pytest.mark.parametrize(
    ('noteset', 'note', 'steps', 'result'), [
        ...
        (NoteSet.from_str('CEG/C'), Note('C'), 1, Note('E')),
        (NoteSet.from_str('CEG/C'), Note('C'), 2, Note('G')),
        (NoteSet.from_str('CEG/C'), Note('C'), 3, Note('C')),
        (NoteSet.from_str('CeGb/C'), Note('e'), 2, Note('b')),
        (NoteSet.from_str('CeGb/C'), Note('e'), 25, Note('G')),
        (NoteSet.from_str('CEG/C'), Note('C'), -1, Note('G')),
        (NoteSet.from_str('CEG/C'), Note('C'), -2, Note('E')),
        (NoteSet.from_str('CEG/C'), Note('C'), -3, Note('C')),
        (NoteSet.from_str('CEG/C'), Note('C'), -3, Note('C')),
        (NoteSet.from_str('CeGb/C'), Note('e'), -15, Note('G')),
    ],
)
