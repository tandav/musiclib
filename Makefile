...
lint:
	...
	python3 -m flake8 --ignore E203,E221,E251,E501,W503,E701,E704,I100,I201 piano_scales
	python3 -m flake8 --ignore E203,E221,E251,E501,W503,E701,E704,I100,I201 tests
